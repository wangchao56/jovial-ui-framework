  ...
  render: () => ({
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 32px;">
        <jv-tabs v-model="activeKey" :items="items" position="top" />
        <jv-tabs v-model="activeKey" :items="items" position="right" />
        <jv-tabs v-model="activeKey" :items="items" position="bottom" />
        <jv-tabs v-model="activeKey" :items="items" position="left" />
      </div>
    `,
  }),
  parameters: {
...
export const Types: Story = {
  render: () => ({
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 32px;">
        <jv-tabs v-model="activeKey" :items="items" type="line" />
        <jv-tabs v-model="activeKey" :items="items" type="card" />
        <jv-tabs v-model="activeKey" :items="items" type="segment" />
      </div>
    `,
  }),
  parameters: {
