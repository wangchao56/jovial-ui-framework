...
import { formProviderKey, converArray } from './form'
...
export default defineComponent({
  ...
  setup(props, { slots, expose }) {
    ...
    const _rules: ComputedRef<FormItemRule[]> = computed(() => {
      let tempRules: FormItemRule[] = converArray(props.rules) // 将 props.rules 转换为 FormItemRule 数组
    ...
    const validate: FormItemContext['validate'] = async (
      ...
      // 获取要校验的属性名
      const modelName =
        props.prop instanceof Array ? props.prop.join('.') : props.prop
