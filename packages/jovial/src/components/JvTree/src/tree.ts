...
export const treeNodeEmits = {
  ...
  check: (_node: TreeNode, checked: boolean) => typeof checked === 'boolean',
  dragStart: (_node: TreeNode) => true,
  dragEnd: (_node: TreeNode) => true,
  dragEnter: (_node: TreeNode) => true,
  dragLeave: (_node: TreeNode) => true,
  dragOver: (_node: TreeNode) => true,
  drop: (_node: TreeNode) => true,
} as const
