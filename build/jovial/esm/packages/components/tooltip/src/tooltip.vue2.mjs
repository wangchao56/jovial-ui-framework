import { defineComponent, ref, openBlock, createElementBlock, normalizeClass, unref, createElementVNode, withModifiers, renderSlot, Fragment, createCommentVNode, createVNode, withCtx, toDisplayString, createBlock } from 'vue';
          ...
          createVNode(_sfc_main$1, {
            ...
            content: withCtx(() => [
              _ctx.content ? (openBlock(), createElementBlock(
                ...
                1
                /* TEXT */
              )) : _ctx.$slots.content ? (openBlock(), createBlock(unref(JvRenderVNodeContent), {
                key: 1,
                render: _ctx.$slots.content
              }, null, 8, ["render"])) : (openBlock(), createBlock(unref(JvRenderVNodeContent), {
                key: 2,
