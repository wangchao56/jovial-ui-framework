import { defineComponent, ref, inject, computed, reactive, toRefs, provide, onMounted, unref } from 'vue';
import { formItemProps, formItemExpose, formItemProviderKey, VALIDATE_STATE } from './form-item.mjs';
import { isString, isEmpty } from '../../../utils/common.mjs';
import { createNamespace } from '../../../utils/create.mjs';
import { formProviderKey, converArray } from './form.mjs';
...
var _formItem = defineComponent({
  ...
  setup(props, { slots, expose }) {
    ...
    const _rules = computed(() => {
      let tempRules = converArray(props.rules);
