import { defineComponent, computed, openBlock, createElementBlock, normalizeClass, unref, createElementVNode, normalizeStyle, createVNode, withCtx, createBlock, createCommentVNode, renderSlot } from 'vue';
import { createNamespace } from '../../../utils/create.mjs';
import { treeNodeProps, treeNodeEmits } from './tree.mjs';
        ...
        [
          createElementVNode(
            ...
            [
              ...
              }, null, 8, ["model-value", "disabled", "indeterminate"])) : createCommentVNode("v-if", true),
