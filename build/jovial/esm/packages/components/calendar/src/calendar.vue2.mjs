import { defineComponent, ref, computed, unref, resolveComponent, openBlock, createElementBlock, normalizeClass, createElementVNode, toDisplayString, createVNode, withCtx, createTextVNode, Fragment, renderList, createBlock, renderSlot } from 'vue';
import { createNamespace } from '../../../utils/create.mjs';
import { calendarProps, calendarEmits, CalendarPeriod, weekMaping, CalendarDateCellType, actionsMapEntries } from './calendar.mjs';
