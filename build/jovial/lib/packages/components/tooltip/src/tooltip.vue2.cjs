...
var popper_vue_vue_type_script_setup_true_lang = require('../../popper/src/popper.vue2.cjs');
var renderVnodeContent_setup = require('../../internal/render-vnode-content.setup.cjs');
          ...
          vue.createVNode(popper_vue_vue_type_script_setup_true_lang.default, {
            ...
            content: vue.withCtx(() => [
              _ctx.content ? (vue.openBlock(), vue.createElementBlock(
                ...
                1
                /* TEXT */
              )) : _ctx.$slots.content ? (vue.openBlock(), vue.createBlock(vue.unref(renderVnodeContent_setup.default), {
                key: 1,
                render: _ctx.$slots.content
              }, null, 8, ["render"])) : (vue.openBlock(), vue.createBlock(vue.unref(renderVnodeContent_setup.default), {
                key: 2,
