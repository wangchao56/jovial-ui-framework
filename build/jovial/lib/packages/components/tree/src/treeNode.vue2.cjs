...
var Loading = require('../../internal-icon/Loading.cjs');
var Switcher = require('../../internal-icon/Switcher.cjs');
var treeNodeContent = require('./tree-node-content.cjs');
        ...
        [
          vue.createElementVNode(
            ...
            [
              ...
              }, null, 8, ["model-value", "disabled", "indeterminate"])) : vue.createCommentVNode("v-if", true),
